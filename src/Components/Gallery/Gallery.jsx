...
const Gallery = () => {
    return (
        <div className="mt-20">
			...
			<h3 className="text-2xl font-bold sm:text-5xl">Things to remember</h3>
			<p className="max-w-2xl dark:text-gray-400 text-center mx-auto">remarkable moment of our services</p>
		</div>
